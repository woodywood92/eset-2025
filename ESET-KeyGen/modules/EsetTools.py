...
class EsetKeygen(object):
    ...
    def sendRequestForKey(self):
        ...
        self.driver.get('https://home.eset.com/onboarding/members/create-owner')
        exec_js(f"""var el = {GET_EBAV}('input', 'data-label', 'member-add-account-owner-input-input')[0]; el.value = '{self.email_obj.email}'; """)
        console_log('Added member !', OK)
